...
class NewsItem(scrapy.Item):
    ...
    summary = scrapy.Field()            # str | None: Article summary (truncated to summary_max_chars)
    ...
    url_hash = scrapy.Field()           # str: SHA-256 of canonicalized URL (tracking params removed)
    fingerprint = scrapy.Field()        # str: SHA-256 of content basis (title + published_at + source, or title + first 2k chars of text)
    ...
    extraction_method = scrapy.Field()  # str: "newspaper3k" | "rss_only" | "html_fallback"
